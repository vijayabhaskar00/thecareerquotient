...
export function Navbar() {
  return (
    <header className="sticky top-0 z-50 bg-gradient-to-b from-offwhite from-40% via-offwhite/80 to-offwhite/0 px-3 pb-6 pt-3 backdrop-blur-md sm:px-4 sm:pt-4">
